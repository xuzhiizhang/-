    ...
    features: [
      {
        ...
        properties: { cp: [121, 24], name: "台湾累计确诊：768543", childNum: 5 }
      },
      {
        id: "130000",
        geometry: {
        ...
        properties: { cp: [115.5, 38.5], name: "河北累计确诊：2004", childNum: 3 }
      },
      {
        id: "140000",
        geometry: {
        ...
        properties: { cp: [112.3, 37.5], name: "山西累计确诊：420", childNum: 1 }
      },
      {
        id: "150000",
        geometry: {
        ...
        properties: { cp: [110, 41], name: "内蒙古累计确诊：1753", childNum: 2 }
      },
      {
        id: "210000",
        geometry: {
        ...
        properties: { cp: [123.2, 41.3], name: "辽宁累计确诊：1669", childNum: 16 }
      },
      {
        id: "220000",
        geometry: {
        ...
        properties: { cp: [126, 43.7], name: "吉林累计确诊：40262", childNum: 1 }
      },
      {
        id: "230000",
        geometry: {
        ...
        properties: { cp: [127.8, 46.8], name: "黑龙江累计确诊：2983", childNum: 2 }
      },
      {
        id: "320000",
        geometry: {
        ...
        properties: { cp: [120, 32.4], name: "江苏累计确诊：2215", childNum: 1 }
      },
      {
        id: "330000",
        geometry: {
        ...
        properties: { cp: [120, 29.2], name: "浙江累计确诊：3130", childNum: 43 }
      },
      {
        id: "340000",
        geometry: {
        ...
        properties: { cp: [117.2, 31.5], name: "安徽累计确诊：1065", childNum: 3 }
      },
      {
        id: "350000",
        geometry: {
        ...
        properties: { cp: [118.2, 26], name: "福建累计确诊：3121", childNum: 18 }
      },
      {
        id: "360000",
        geometry: {
        ...
        properties: { cp: [115.7, 28], name: "江西累计确诊：1383", childNum: 1 }
      },
      {
        id: "370000",
        geometry: {
        ...
        properties: { cp: [117.5, 36.3], name: "山东累计确诊：2734", childNum: 13 }
      },
      {
        id: "410000",
        geometry: {
        ...
        properties: { cp: [113.6, 34], name: "河南累计确诊：3122", childNum: 2 }
      },
      {
        id: "420000",
        geometry: {
        ...
        properties: { cp: [113, 31], name: "湖北累计确诊：68398", childNum: 3 }
      },
      {
        id: "430000",
        geometry: {
        ...
        properties: { cp: [112, 28], name: "湖南累计确诊：1393", childNum: 3 }
      },
      {
        id: "440000",
        geometry: {
        ...
        properties: { cp: [113.5, 23], name: "广东累计确诊：7257", childNum: 24 }
      },
      {
        id: "450000",
        geometry: {
        ...
        properties: { cp: [108.5, 23.5], name: "广西累计确诊：1610", childNum: 2 }
      },
      {
        id: "460000",
        geometry: {
        ...
        properties: { cp: [110, 19.5], name: "海南累计确诊：288", childNum: 1 }
      },
      {
        id: "510000",
        geometry: {
        ...
        properties: { cp: [103.5, 30.6], name: "四川累计确诊：2092", childNum: 2 }
      },
      {
        id: "520000",
        geometry: {
        ...
        properties: { cp: [106.7, 26.6], name: "贵州累计确诊：184", childNum: 3 }
      },
      {
        id: "530000",
        geometry: {
        ...
        properties: { cp: [102, 24.7], name: "云南累计确诊：2127", childNum: 1 }
      },
      {
        id: "540000",
        geometry: {
        ...
        properties: { cp: [91, 30.5], name: "西藏累计确诊：1", childNum: 1 }
      },
      {
        id: "610000",
        geometry: {
        ...
        properties: { cp: [108.9, 34.26], name: "陕西累计确诊：3278", childNum: 1 }
      },
      {
        id: "620000",
        geometry: {
        ...
        properties: { cp: [104, 35.5], name: "甘肃累计确诊：681", childNum: 3 }
      },
      {
        id: "630000",
        geometry: {
        ...
        properties: { cp: [97, 36], name: "青海累计确诊：146", childNum: 2 }
      },
      {
        id: "640000",
        geometry: {
        ...
        properties: { cp: [106.1, 37.5], name: "宁夏累计确诊:122", childNum: 1 }
      },
      {
        id: "650000",
        geometry: {
        ...
        properties: { cp: [87, 41], name: "新疆累计确诊：1008", childNum: 1 }
      },
      {
        id: "110000",
        geometry: {
        ...
        properties: { cp: [116.4, 40.24], name: "北京累计确诊：2740", childNum: 1 }
      },
      {
        id: "120000",
        geometry: {
        ...
        properties: { cp: [116.87, 39.5], name: "天津累计确诊：1804", childNum: 1 }
      },
      {
        id: "310000",
        geometry: {
        ...
        properties: { cp: [121.4, 31.1], name: "上海累计确诊：62104", childNum: 7 }
      },
      {
        id: "500000",
        geometry: {
        ...
        properties: { cp: [107.5, 29.7], name: "重庆累计确诊：708", childNum: 1 }
      },
      {
        id: "810000",
        geometry: {
        ...
        properties: { cp: [115.2, 22.75], name: "香港累计确诊：331613", childNum: 5 }
      },
      {
        id: "820000",
        geometry: {
        ...
        properties: { cp: [114.52, 22.86], name: "澳门累计确诊：82", childNum: 1 }
      }
    ],
    UTF8Encoding: true
  });
